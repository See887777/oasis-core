...
var (
	baseLogger = logging.GetLogger("cometbft/db/badger")
...
// New constructs a new CometBFT DB, backed by a Badger database at
// the provided path.
//
// Note: This should only be used by CometBFT, all other places
...
func (d *badgerDBImpl) newIterator(start, end []byte, isForward bool) dbm.Iterator {
	...
	// TODO/perf:
	//  * opts.Prefix is likely worth setting, but maybe the CometBFT
